...
CREATE TABLE `quanlytienphat` (
  ...
  KEY `FK_QUANLYTIENPHAT_DOCGIA_MDG_idx` (`MaDocGia`),
  CONSTRAINT `FK_QUANLYTIENPHAT_DOCGIA_MDG` FOREIGN KEY (`MaDocGia`) REFERENCES `docgia` (`MaDocGia`)
...
-- Dump completed on 2019-11-27 10:25:32
